...
function setValueByPath(data, keys, value) {
	for (let i = 0; i < keys.length - 1; i++) {
		...
		if (key.endsWith("[]")) {
			...
			if (!(keyName in data)) {
				if (Array.isArray(value)) data[keyName] = Array.from({ length: value.length }, () => ({}));
...
function resourceName(client, resourceName, resourcePrefix, splitsAfterPrefix = 1) {
	...
	if (client.isVertexAI()) {
		if (resourceName.startsWith("projects/")) return resourceName;
...
function tBatchJobName(apiClient, name) {
	...
	if (!apiClient.isVertexAI()) {
		if (/batches\/[^/]+$/.test(nameString)) return nameString.split("/").pop();
...
function partToMldev$4(fromObject) {
	...
	if (fromMediaProcessing != null) setValueByPath(toObject, ["mediaProcessing"], fromMediaProcessing);
	return toObject;
}
...
var LIBRARY_LABEL = `google-genai-sdk/2.19.0`;
	...
	*/
	async connect(params) {
		...
		if (this.apiClient.isVertexAI() && ((_c = params.config) === null || _c === void 0 ? void 0 : _c.responseModalities) === void 0) {
			if (params.config === void 0) params.config = { responseModalities: [Modality.AUDIO] };
		...
		this.list = async (params) => {
			...
			if (this.apiClient.isVertexAI()) {
				if (!actualParams.config.queryBase) {
					if ((_a = actualParams.config) === null || _a === void 0 ? void 0 : _a.filter) throw new Error("Filtering tuned models list is only supported in Gemini Developer API mode, not in Gemini Enterprise Agent Platform mode.");
...
var SDK_METADATA = { userAgent: "speakeasy-sdk/typescript 2.4.1-preview.4 internal v1beta @google/genai" };
/**
* @license
* Copyright 2026 Google LLC
* SPDX-License-Identifier: Apache-2.0
	...
	return resolveSecurity(...[[
		{
			...
			type: "http:custom",
			value: (_a = security === null || security === void 0 ? void 0 : security.access_token) !== null && _a !== void 0 ? _a : env().GOOGLE_GENAI_ACCESS_TOKEN
		},
		{
			fieldName: "apiKey",
			type: "http:custom",
...
var GeminiNextGenInteractions = class {
	...
	async get(id, params = {}, options) {
		...
		return addOutputPropertiesIfInteraction(await unwrapWithSdkHttpResponse(interactionsGet(this.getClient(api_version), id, api_version, include_input, last_event_id, stream, toGoogleGenAIRequestOptions(options))));
	}
